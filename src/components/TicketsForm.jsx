...
function TypeForm({setVipTickets, setRegularTickets}) {
  ...
  return (
    ...
    <div className="tickets_regular">
         <label className="tickets_regular_label" htmlFor="quantityRegular"><h3 className="tickets_regular_h3">Regular</h3> <h4>799,-</h4> <p>pr. ticket</p></label>
       ...
       <div className="tickets_vip">
            <label className="tickets_vip_label" htmlFor="quantityVip"><h3 className="tickets_vip_h3">VIP</h3> <h4>1.299,-</h4> <p>pr. ticket</p></label>
